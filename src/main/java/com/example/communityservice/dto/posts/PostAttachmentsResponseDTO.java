...
public class PostAttachmentsResponseDTO {
  ...
  @Schema(description = "원본 파일명", example = "첨부파일_사진.jpg")
  private String originalFilename;

  @Schema(description = "저장된 파일명", example = "20250915_103000_abc123.jpg")
  ...
  private Long fileSize; // 개발자용 바이트 표시

  @Schema(description = "포맷된 파일 크기", example = "1.0 MB")
  private String formattedFileSize; // 사용자 친화적 표시
